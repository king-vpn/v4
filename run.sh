...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/king-vpn/v4/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/king-vpn/v4/main/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/king-vpn/v4/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/king-vpn/v4/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/king-vpn/v4/main/REGIST | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/king-vpn/v4/main/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/kingVpn"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6281315010096"}]]}'
...
wget raw.githubusercontent.com/king-vpn/v4/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
